            ...
            <div id="place-picker" onKeyDown={this.props.onKeyDown.bind(this)}>
                <div id="place-picker-search-pane">
                    ...
                    <div id="place-picker-actions-bar">
                        <button className={"button purple " + (this.props.carousel ? 'outline' : 'fill')} onClick={Picker.accept.bind(this, { embedType: 'place', place: this.state.selectedPlace })}>Add Selected Place</button>
