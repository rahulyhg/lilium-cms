            ...
            <div id="place-picker">
                <div id="place-picker-search-pane">
                    ...
                    <div id="place-picker-actions-bar">
                        <button className={"button purple " + (this.props.isCarousel ? 'outline' : 'fill')} onClick={Picker.accept.bind(this, { embedType: 'place', place: this.state.selectedPlace })}>Add Selected Place</button>
