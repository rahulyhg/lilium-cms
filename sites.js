...
var SiteInitializer = function(conf) {
	...
	this.precompile = function(done) {
		...
		Frontend.registerJSFile(htmlbase + "/compiled/lilium.js", 10000, 'admin', conf.id);
		Frontend.registerJSFile(htmlbase + "/compiled/ckeditor-lilium.js", 700, 'admin', conf.id);
		...
		Frontend.registerCSSFile(htmlbase + "/compiled/lilium.css", 10000, 'admin', conf.id);
