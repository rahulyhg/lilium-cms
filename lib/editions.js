...
module.exports.updatePostsAfterMerge = function(_c, then, now, done) {
    let ctn = 0;
...
module.exports.fieldToRef = function(field, value) {
    return field == "icon" || field == "featuredimage" ? db.mongoID(value) : value;
}

module.exports.getFull = function(_id, sendback) {
