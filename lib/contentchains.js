...
class ContentChainsLib {
    ...
    insertNewChain(cli, data, callback) {
        let newChain = this.createFromObject(data);
        newChain.createdBy = db.mongoID(cli.userinfo.userid);
        
        db.insert(cli._c, 'contentchains', newChain, (err, r) => {
